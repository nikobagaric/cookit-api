...
export default class RecipesController {
   ...
   * @responseBody 201
   * @responseBody 404
   * @requestBody {"title": "string", "description": "string", "difficulty": "1-5", "image": "file", "ingredients": "list"}
   */
   ...
   * @responseBody 200
   * @responseBody 404
   * @requestBody {"title": "string", "description": "string", "difficulty": "1-5", "image_url": "string"}
   */
